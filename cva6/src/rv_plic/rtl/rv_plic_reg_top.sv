...
module rv_plic_reg_top (
  ...
  // Note(eunchan): Fix it after bus interface is finalized
  ...
  // Note(eunchan): Revise Register Interface logic after REG INTF finalized
  // Note(eunchan): Make concrete scenario
